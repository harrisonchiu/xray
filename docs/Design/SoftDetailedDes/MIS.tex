...
\wss{You should describe your notation. You can use what is below as a starting point. ---SS}
...
\begin{itemize}
    ...
    \item Valid roles (ROLE_USER, ROLE_ADMIN, etc.) are seeded or pre-created in the system.
