...
\begin{table}[ht]
    ...
    \textbf{M1 - Data Preprocessing Tests} & FRTC1, FRTC2, NFRTC1 & Tests preprocessing functions like resizing, normalizing, and grayscale conversion. Ensures correct dataset organization. \\ \hline
