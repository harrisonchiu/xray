...
2 April & 1.1 & Gurnoor, Harrison, Jared, Hamza, Ahmad add extra sections and details to address Github issues feedback\\
\bottomrule
\end{tabularx}
...
\end{itemize}
\textbf{Actual Output:} 66\% of users reported that the interface was simple and distraction-free.
\textbf{Expected and Actual Output Match:} True  
